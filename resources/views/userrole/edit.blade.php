...
@section('section-heading')
 {{ trans('user.edit_roles') }}
@endsection
    <div class="contentpanel">
    @include('layouts.errors')
        <div class="content-header clearfix">
                <h2>{{ trans('user.edit_roles') }}</h2>
            </div>
        <div class="content clearfix" data-ng-controller="RoleController as roleCtrl" data-ng-init="roleCtrl.fetchUserRoleSingleInfo({{$id}})">
