<div class="content-header clearfix">
    <h2 class="col-md-6 col-sm-6 col-xs-6 nopadding">{{trans('sms.sms_template')}}</h2>
    <div class="col-md-6 col-sm-6 col-xs-6 nopadding">
        <a href="{{url('sms/add')}}" class="button blue-button">Add Sms Template</a>
    </div>
</div>
<div class="table-tab">
    ...
    <div class="tab-content">
            ...
            <div class="table-responsive">
                ...
                <table class="table tablesaw" data-tablesaw-mode="columntoggle">
                    <thead>
                            ...
                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">{{trans('sms.name')}}</th>
                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">Slug</th>
                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">{{trans('sms.subject')}}</th>
                        ...
                        <tr class="search-row">
                            ...
                            <td>
                                <div class="tooltip1">
                                    ...
                                    <span class="tooltiptext">{{trans('sms.name')}}</span>
                                </div>
                            </td>
                            <td></td>
                            <td></td>
        ...
        <button type="button" class="danger product_list_reset_btn" name="reset" data-ng-click="gridReset()" value="{{trans('general.reset')}}" data-boot-tooltip="true" data-toggle="tooltip" data-original-title="{{trans('general.reset')}}"><i class="fa fa-refresh"></i></button>
                        ...
                        <tr data-ng-if="showRecords" data-on-finish-rendered data-ng-repeat="record in records track by $index">
                            ...
                            <td>
                              <a ng-href="{{url('sms/edit').'/'}}@{{record.id}}">
