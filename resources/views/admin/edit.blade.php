...
{{ trans('user.edit_admin') }}
@endsection
<div class="contentpanel">
   <div class="content-header clearfix">
      <h2>{{ trans('user.edit_admin') }}</h2>
   </div>
   @include('layouts.errors')
   <div class="content clearfix" data-ng-controller="AdminUserController as adminUserCtrl" data-ng-init = "adminUserCtrl.fetchadminUserSingleInfo({{$id}})">
                        ...
                        <div class="form-group" data-ng-class="{'has-error': errors.company.has}">
                           ...
                           <div class="col-md-12" >
                              <select class="form-control" name="company"
                                 data-ng-model="adminUserCtrl.adminUser.company" >
                  ...
                  <div class="form-group">
                          <div class="col-md-12 user-image">
                              ...
                              <div id="user-profile-image"  class="profile-image">
                                 ...
                                 <img data-ng-if="adminUserCtrl.adminUser.profile_image == ''" src="{{asset('assets/images/default-user.png')}}">
                                <img data-ng-if="adminUserCtrl.adminUser.profile_image != ''" data-ng-src="@{{adminUserCtrl.adminUser.profile_image}}">  
                                 </label>                           
                              </div>
