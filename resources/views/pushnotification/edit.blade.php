...
<div class="contentpanel">
   <div class="content-header clearfix">
    ...
    <div class="content clearfix" data-ng-controller="PushNotificationController as pushNotifyCtrl" data-ng-init="pushNotifyCtrl.fetchSingleInfo({{$id}})" >
            <form method="post" data-base-validator data-ng-submit = "pushNotifyCtrl.save($event)" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-page clearfix">
                ...
                <div class="form-group" data-ng-class="{'has-error': errors.name.has}">
                        ...
                        <div class="col-md-6">
                            <input class="form-control"  name="name" data-ng-model="pushNotifyCtrl.pushNotification.name" />
                    ...
                    <div class="form-group" data-ng-class="{'has-error': errors.subject.has}">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="subject" data-ng-model='pushNotifyCtrl.pushNotification.subject'>
                    ...
                    <div class="form-group" data-ng-class="{'has-error': errors.body.has}">
                        ...
                        <div class="col-md-10">
                            <textarea  id="wysiwyg" rows='14' class="form-control" data-ng-model="pushNotifyCtrl.pushNotification.body" name='body'></textarea>
            ...
            <div class="form-page clearfix">
                      <div class="col-md-8">
                          ...
                          <div class="col-md-8">
                              ...
                              <a href="{{url('pushnotification')}}" class="btn-default btn">{{ trans('general.cancel') }}</a>
                          </div>
                      </div>
                  </div>
            </form>
...
<script src="{{asset('assets/js/modules/pushnotification/app.js')}}"></script>
