"use strict";
var email = angular.module("apptha.email", []);
...
email.controller("EmailController", ["$window", "$scope", "requestFactory", "$rootScope", function($window, scope, requestFactory, $rootScope) {
    ...
    this.fetchSingleInfo = function(id) {
        this.id = id;
        requestFactory.get(requestFactory.getUrl("emailtemplate/" + this.id + "/edit"), function(response) {
...
angular.element(document).ready(function() {
    angular.bootstrap(document, ["apptha.email"]);
});