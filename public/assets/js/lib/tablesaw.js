...
;(function( win, $, undefined ){
	...
	ColumnToggle.prototype.init = function() {
		...
		$( this.headers ).not( "td" ).each( function() {
			...
			if( priority && priority !== "persist" ) {
				...
				$("<label><input data-index='"+iter+"' type='checkbox' checked>" + $this.text() + "</label>" )
					.appendTo( $menu )
					.children( 0 )
					.data( "cells", $cells );
	...
	ColumnToggle.prototype.reIntializeHeader = function(intializedHeaders) {
		this.$menu.find( 'input[type="checkbox"]' ).each(function() {
			var index = $(this).data("index");
			this.checked = (intializedHeaders.hasOwnProperty(index)) ? intializedHeaders[index] : true;
			
			$(this).data( "cells" )
				.toggleClass( "tablesaw-cell-hidden", !this.checked )
				.toggleClass( "tablesaw-cell-visible", this.checked );
		});
	};
