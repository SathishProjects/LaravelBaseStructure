...
abstract class Repository implements GridableInterface,ResourceInterface {
    use ValidationHandler,GridHandler,ResourceHandler;
    /**
    ...
    public function __construct() {
        ...
        $this->setRequestType(static::REQUEST_TYPE_API);
    }
    /**
    ...
    public function setRequestType($requestType) {
    	if(in_array($requestType,$this->requestTypes)){
    		...
    		app()->singleton('repository.requestype',function(){
    	...
    	throw new InvalidRequestException(trans('base::messages.invalid_request_type_supplied'),403);
