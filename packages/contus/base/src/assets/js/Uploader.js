  ...
  this.initate = function(options) {
      ...
      */ 
      if(this.isBrowserSupportedHtmlFive()){
        ...
        var opt = {
            ...
            locale      : {
              ...
              error : {
                ...
                mime              : "Image should in :mime",
                fileSize          : "Image size should be less than :maxSize MB",
                invalid           : "Image selected is Invalid",                
        ...
        /**
         * If the uploaded type not image
         * make sure request param name is updated
         */
        if(!this.options.isImageFileType){
          this.requestFileName = "file";  
        }
